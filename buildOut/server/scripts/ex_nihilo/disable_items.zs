...
mods.jei.JEI.removeAndHide(<exnihilocreatio:item_ore_iron:0>); // Iron ore piece.
mods.jei.JEI.removeAndHide(<exnihilocreatio:item_ore_iron:1>); // Iron ore chunk.


// Remove porcelain clay since it conflicts with ceramics unfired porcelain and is functionally the same.
