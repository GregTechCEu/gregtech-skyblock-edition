...
reactor.recipeBuilder().inputs([<ore:plateGold>, <ore:plateLapis>]).fluidInputs([liquidXP*1000]).outputs([<extrautils2:ingredients:12>]).EUt(80).duration(120).buildAndRegister();
reactor.recipeBuilder().inputs([<ore:blockIron>, <minecraft:nether_star>]).fluidInputs([liquidXP*1000]).outputs([<extrautils2:ingredients:17>*8]).EUt(8000).duration(1200).buildAndRegister();
